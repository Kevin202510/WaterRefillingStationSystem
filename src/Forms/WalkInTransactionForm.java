 ...
 * @author KevinCaluag
 */
public class WalkInTransactionForm extends javax.swing.JFrame {

    /**
     * Creates new form WalkInTransactionForm
     */
   static int transactionlogsId;
    ...
    public WalkInTransactionForm(int transactionlogsId,JTable walkinTable,JFrame out,JPanel lalagyanan) {
        initComponents();
    ...
    public void getDeliveriesInfo(int id){
          try {
              ...
              ResultSet rs = st.executeQuery("SELECT * FROM `transactions` LEFT JOIN customers ON customers.ID = transactions.Customer_Id LEFT JOIN gallons ON gallons.Code = transactions.Gallon_Id LEFT JOIN promos ON promos.Id = transactions.Promo_Id LEFT JOIN users ON users.Id = transactions.User_Id WHERE transactions.ID = '"+id+"' AND transactions.ServiceType = 0");
...
//                  Quantity.setValue(rs.getInt("transactions.Quantity"));
           ...
           java.util.logging.Logger.getLogger(WalkInTransactionForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       } 
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 70, 40));
        ...
        jPanel1.add(updatebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 400, 180, 30));
        ...
        jPanel1.add(deletebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 440, 180, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WalkInTransactionForm(transactionlogsId,walkinTable,out,lalagyanan).setVisible(true);
            }
        });
    }
