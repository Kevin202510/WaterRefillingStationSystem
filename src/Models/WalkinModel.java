...
public class WalkinModel {
    ...
    public WalkinModel(int Id,int Customer_Id,String Date_Order,String Date_Delivered,String Gallon_Id,int Quantity,int Promo_Id,int Status,int User_Id){
        this.Id = Id;
    ...
    public WalkinModel(String Customer_Fname,String Customer_Mname,String Customer_Lname,String Customer_Address,String Gallon_Name,String Promo_Description,String User_Fname,String User_Mname,String User_Lname){
    ...
    public WalkinModel(int id,int status){
        this.Id = id;
        this.Status = status;
